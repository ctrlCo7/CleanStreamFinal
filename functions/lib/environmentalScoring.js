...
function estimateCleanupHours(riskScore, objectCount) {
...
function objectCountScore(objectCount) {
    if (objectCount === 0)
        return 0;
...
function detectionDensityScore(densityScore) {
...
function coverageScore(coverageRatio) {
...
// ─── Public API ───────────────────────────────────────────────────────────────
function computeEnvironmentalScore(yoloResult) {
...
//# sourceMappingURL=environmentalScoring.js.map